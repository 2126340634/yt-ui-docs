...
```vue
<yt-movableView direction="vertical" :outOfBounds="false" :damping="25" :y="panelY" @change="handlePanelDrag">
  ...
  <view class="image-viewer">
    ...
    <view class="viewer-container">
      <yt-movableView
        ...
        @scaleChange="handleImageZoom"
      >
        <image src="https://example.com/image.jpg" mode="aspectFit" class="viewer-image" />
      </yt-movableView>
    </view>
    <view class="controls">
      <view class="info">
      ...
      <view class="buttons">
        <yt-button @click="resetImage" size="small"> 重置 </yt-button>
      </view>
    </view>
  </view>
</template>
