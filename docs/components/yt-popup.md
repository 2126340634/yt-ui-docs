...
```vue
<yt-popup :visible="show" bgColor="#f8f9fa" overlayColor="rgba(0,0,0,0.4)" :borderRadius="20" :duration="300">
  <view>自定义样式</view>
</yt-popup>
```
...
```vue
<yt-popup :visible="show" @overlayClick="handleOverlay" @open="handleOpen" @opened="handleOpened" @close="handleClose" @closed="handleClosed">
  <view>事件演示</view>
</yt-popup>
```
